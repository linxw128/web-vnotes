  ...
  return (
    <>
      <div className="flex items-center border border-zinc-800 px-3 py-2 gap-2 shadow-sm sm:text-sm">
        ...
        <label htmlFor="SearchBox" className="sr-only background-blue-50">
          Search Posts
        </label>
      ...
      <div className="pt-8 background-blue-50">
        {fuse.search(input).map((result: any, index: any) => (
          <a href={`/blog/${result.item.slug}`} key={index}>
            <div className="text-green-500 text-xl p-2 border-b border-zinc-800 hover:bg-zinc-800 hover:text-white transition-all ease-in-out duration-300 cursor-pointer">
